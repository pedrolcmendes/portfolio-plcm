...
const links = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/pedrolcmendes',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/pedrolcmendes',
    icon: (
      <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section id="contact" className="contact">
      <div ref={ref} className="reveal contact__inner">
        ...
        <h2 className="contact__big">
          Vamos<br />Construir<br />
          <span>Algo.</span>
        </h2>

        <p className="contact__sub">
          Aberto a oportunidades de estágio, freela e colaborações.
